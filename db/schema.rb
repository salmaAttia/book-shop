...
ActiveRecord::Schema.define(version: 20171009074406) do
  ...
  create_table "orderitems", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "order_id"
    t.integer "book_id"
    t.float   "purched_price",  limit: 24
  ...
  create_table "users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "avatar_updated_at"
    t.boolean  "admin"
    t.binary   "avatar_file",            limit: 4294967295
    t.binary   "avatar_small_file",      limit: 4294967295
    t.binary   "avatar_thumb_file",      limit: 4294967295
